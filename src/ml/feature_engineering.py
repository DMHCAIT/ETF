...
try:
    ...
    logging.warning("TA library not available - technical indicators disabled")
    TA_AVAILABLE = False

# sklearn components with fallback
try:
    ...
    logging.warning("scikit-learn not available - advanced preprocessing disabled")
