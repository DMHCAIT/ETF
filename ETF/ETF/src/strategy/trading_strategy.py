...
class TradingStrategy:
    """
    Implements the core trading strategy with TrueData real-time capabilities:
    - Buy Condition: Price drops ≥ 1% from previous close
    - Sell Condition: Price increases 5% from purchase price
    - Stop-Loss: Price falls 3% below purchase price
    ...
    def __init__(self, config: Config, data_fetcher: DataFetcher):
        ...
        self.sell_target = config.get('trading.sell_target', 0.05)       # +5%
        self.stop_loss = config.get('trading.stop_loss', -0.03)          # -3%
    ...
    def _generate_real_time_signal(self, symbol: str, quote_data: Dict) -> Optional[Dict]:
        ...
        try:
            ...
            # Additional buy signal: Strong intraday dip
